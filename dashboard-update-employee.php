...
if (isset($_GET['employeeID'])) {
    ...
    // Fetch employee data from the database using the employeeID
    // Example: Assuming you have a function to get employee data
    include 'employee.php'; // Ensure this file connects to the database

    // Fetch employee data based on employeeID
    $sql = "SELECT username, email, employeeType FROM employee WHERE employeeID = ?";
                ...
                <form action="update-employee.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select id="role" name="role" required>
                            ...
                            <option value="manager">Assistant Admin</option>
